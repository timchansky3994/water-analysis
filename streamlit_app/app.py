...
_page_analyze = st.Page("pages/1_report.py", title="Анализ и отчёт", icon="📊")
_page_view = st.Page("pages/2_view_report.py", title="Просмотр отчёта", icon="📂")
_page_estimate = st.Page("pages/3_estimate.py", title="Расчёт отсутствующих", icon="🔢")
...
"""
    ...
    with col1:
        st.subheader("Анализ и отчёт")
        st.write("Загрузите файл данных, выберите сценарий и целевой показатель — получите полный отчёт.")
